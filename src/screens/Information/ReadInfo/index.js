...
const ReadInfo = ({navigation, route}) => {
  return (
    <>
      <StatusBar
      ...
      <View style={s.header}>
        ...
        <Text style={s.headerTitle}>Informasi</Text>
      </View>
      ...
      <SkeletonContent
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View style={s.container}>
            <Text style={s.text_title}>{this.props.text} virus corona.</Text>
            <View style={s.space(20)} />
            {this.props.text === 'Mengenal' ? (
              <Data.Mengenal />
            ) : this.props.text === 'Mencegah' ? (
              <Data.Mencegah />
            ) : this.props.text === 'Mengobati' ? (
              <Data.Mengobati />
            ) : this.props.text === 'Mengantisipasi' ? (
              <Data.Mengantisipasi />
            ) : (
